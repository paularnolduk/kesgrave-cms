    ...
    try:
        ...
        try:
            ...
            for event in sample_events:
                print(f"🔍 DEBUG: Sample event: ID={event.id}, Title={event.title}, Start_Date={event.start_date}, Status={event.status}, Published={event.is_published}")
        except Exception as e:
            print(f"🔍 DEBUG: Error querying Event table: {e}")
        
        # Get events that are in the future and published
        today = date.today()
        print(f"🔍 DEBUG: Looking for events with start_date >= {today} and is_published = True")
        ...
        for event in events_list:
            ...
            # Get categories for this event with colors (MINIMAL ADDITION)
            categories = []
            try:
                ...
                for assignment, category in category_assignments:
                    category_data = {
                        ...
                        'icon': getattr(category, 'icon', 'fas fa-calendar')
                    }
            ...
            event_data = {
                ...
                'featured_image': featured_image_url,
                'categories': categories,  # MINIMAL ADDITION
