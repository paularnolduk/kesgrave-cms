...
def edit_content_page(page_id):
    ...
    if request.method == 'POST':
        ...
        if review_date:
            try:
                page.review_date = datetime.strptime(review_date, '%Y-%m-%d').date()
            except ValueError:
                page.review_date = None
        else:
            page.review_date = None
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5><i class="fas fa-calendar-check me-2"></i>Review Information</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Review Date (Optional)</label>
                                    <input type="date" class="form-control" name="review_date" value="{{ page.review_date.strftime('%Y-%m-%d') if page.review_date else '' }}">
