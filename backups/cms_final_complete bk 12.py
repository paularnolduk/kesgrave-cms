...
@app.route('/councillors')entPage.query.count(),
         events_count=Event.query.filter(Event.start_date >= datetime.now()).count(),
         datetime=datetime, sidebar_html=get_sidebar_html('dashboard'), sidebar_css=get_sidebar_css())          {% endif %}
                                </div>
...
def content_review_system():
    ...
    content_pages = query.order_by(ContentPage.next_review_date.asc().nullslast()).all()
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Content Pages Review Status</h5>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/content/pages/edit/{{ page.id }}" class="btn btn-sm btn-outline-primary">
            ...
            document.querySelectorAll('.summary-card').forEach(card => {
                card.addEventListener('click', function(e) {
                    ...
                    if (href && href.includes('filter=')) {
                        // Apply the filter by redirecting
